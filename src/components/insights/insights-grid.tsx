...
const articles = [
  {
    ...
    image: PlaceHolderImages.find((p) => p.id === "insights-1"),
  ...
  },
  {
    ...
    category: "Case Study",
    image: PlaceHolderImages.find((p) => p.id === "insights-2"),
  ...
  },
  {
    ...
    category: "CSR",
    image: PlaceHolderImages.find((p) => p.id === "insights-3"),
  ...
  },
  {
    ...
    category: "Techniques",
    image: PlaceHolderImages.find((p) => p.id === "insights-4"),
