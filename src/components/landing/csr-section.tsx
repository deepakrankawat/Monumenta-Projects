  ...
  return (
    <section className="py-20 bg-card border-y border-border overflow-hidden">
      <Container className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8 opacity-70 grayscale-[50%] text-foreground p-8 rounded-lg bg-background border border-border">
          <div className="flex items-center gap-3" title="Archaeological Survey of India">
            ...
            <span className="font-bold text-xl font-display">ASI India</span>
          </div>
          <div className="flex items-center gap-3" title="Rajasthan Tourism">
            ...
            <span className="font-bold text-xl font-display">Rajasthan Tourism</span>
          </div>
          <div className="flex items-center gap-3" title="Major Indian Conglomerate">
            ...
            <span className="font-bold text-xl font-display">Corporate Foundations</span>
          </div>
           <div className="flex items-center gap-3" title="Global Heritage Funds">
            <span className="material-symbols-outlined text-4xl text-primary">museum</span>
            <span className="font-bold text-xl font-display">Heritage Trusts</span>
          </div>
        </div>
      </Container>
    </section>
