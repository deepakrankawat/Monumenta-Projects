  ...
  return (
    <section className="py-20 md:py-28 bg-background relative">
      <Container className="max-w-4xl mx-auto text-center">
        ...
        <h3 className="text-3xl md:text-5xl font-medium mb-8 text-primary leading-tight font-display">
            Breathing new life into <br className="hidden md:block"/>India's architectural history.
        </h3>
        <p className="text-lg md:text-xl text-muted-foreground leading-loose font-body">
