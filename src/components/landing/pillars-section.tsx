      ...
      <Container className="relative">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8 border-b border-border pb-8">
          <div>
            ...
            <h3 className="text-4xl md:text-5xl font-medium text-foreground font-display">Key Pillars of Our Work</h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {pillars.map((pillar) => (
            <div key={pillar.title} className="group p-8 rounded-lg bg-card border border-border/50 hover:border-accent/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-1">
              ...
              <h4 className="text-2xl font-medium mb-6 text-foreground group-hover:text-primary transition-colors font-display">{pillar.title}</h4>
