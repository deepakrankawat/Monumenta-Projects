  ...
  return (
    <section className="py-28 relative overflow-hidden bg-primary">
      ...
      <Container className="relative text-center flex flex-col items-center">
        <h2 className="text-4xl md:text-5xl font-medium text-primary-foreground mb-8 font-display max-w-3xl">Have a heritage site that needs conservation?</h2>
        <p className="text-xl text-primary-foreground/90 mb-12 max-w-2xl mx-auto font-light">Whether it's a structural audit or a full-scale restoration, our team is ready to help you build a legacy.</p>
