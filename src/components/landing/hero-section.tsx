...
export function HeroSection() {
  ...
  return (
    <section className="relative h-[80vh] min-h-[500px] md:h-screen flex items-center justify-center text-center text-primary-foreground">
      {heroImage && (
        <Image
      ...
      <Container className="relative z-10 flex flex-col items-center">
        ...
        <p className="mt-6 max-w-2xl text-lg md:text-xl font-light text-primary-foreground/90 drop-shadow-sm">
          A specialised conservation firm working on monumental and architectural restoration projects in India.
        </p>
